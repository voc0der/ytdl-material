...
<a href="https://github.com/voc0der/ytdl-material/blob/main/CONTRIBUTING.md#coverage">
  <img src="https://img.shields.io/badge/coverage-61.0%25-yellow" alt="Code coverage percentage" />
</a>
...
Generate an API token from **Your Profile** to let scripts and other apps act as you. Send it as `Authorization: Bearer <token>`. RSS feeds use a separate feed-only token generated by the RSS dialog. Enable API documentation in Settings -> *Extra* and restart for endpoint details.
